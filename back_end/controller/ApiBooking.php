...
class ApiBooking
{
    ...
    public function rentCar()
    {
        ...
        $Booking->client_id_fk = $data->user_id;
        $Booking->vehicle_id_fk = $data->vehicle_id;
        
        if ($Booking->InsertIntoBooking()) {
    ...
    public function getAllBookings($id){
        ...
        if ($result){
            ...
            while ($row = $result->fetch(PDO::FETCH_ASSOC)) {
                ...
                $u[$i] = array('booking_id' => $booking_id,
                            'vehicle_id' => $id,
                            'type' => $type,
                            'brand' => $brand,
                            'color' => $color,
